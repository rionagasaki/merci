...
class StoreKitManager: ObservableObject {
    ...
    func requestProducts() async {
        do {
            ...
            print(productDict.keys)
            storeProducts = try await Product.products(for: productDict.keys)
    ...
    func purchase(product: Product, completion: @escaping()-> Void) async throws -> Transaction? {
